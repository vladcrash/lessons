...
import com.example.admin.lesson5.service.ForecastService;

import java.util.List;

public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    public static final String FORECASTS_SAVED = "com.example.admin.lesson5.activity.MainActivity.FORECASTS_SAVED";
